...
dev_params! {
    ...
    VR_MFD_GRIP_MARGIN = Body::float("vr_mfd_grip_margin", "MFD grip-edge bezel (m)", 0.035, 0.0, 0.08, 0.005),
    ...
    VR_MFD_LEFT_GRIP_EDGE = Tricorder::float("vr_mfd_left_grip_edge", "Left edge: 0 bottom, 1 left, 2 top, 3 right", 0.0, 0.0, 3.0, 1.0),
    VR_MFD_LEFT_GRIP_CLEARANCE = Tricorder::float("vr_mfd_left_grip_clearance", "Left alternate-edge clearance (m)", 0.02, 0.0, 0.06, 0.005),
    ...
    VR_MFD_RIGHT_GRIP_EDGE = Tricorder::float("vr_mfd_right_grip_edge", "Right edge: 0 bottom, 1 left, 2 top, 3 right", 0.0, 0.0, 3.0, 1.0),
