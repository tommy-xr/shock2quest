...
pub fn closed_fist_pose() -> Pose {
    let no_rotation = Quaternion::zero();
    let inward_rotation_1 = Quaternion::from_angle_z(Deg(20.0)); // Try X rotation for finger curl
    let inward_rotation_2 = Quaternion::from_angle_z(Deg(30.0));
    let inward_rotation_3 = Quaternion::from_angle_z(Deg(40.0));
    let inward_rotation_4 = Quaternion::from_angle_z(Deg(30.0)); // Smaller angles
    let inward_rotation_5 = Quaternion::from_angle_z(Deg(20.0));
