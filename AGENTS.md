...
`CLAUDE.md` is a compatibility symlink to this file so Claude Code and Codex use
the same workflow and engine reference.
...
**pr-visuals skill** (`.agents/skills/pr-visuals/`): it drives the headless
